...
export default [
  {
    "title": "Online Art Gallery — Full Stack Web Application",
    "description": "A full-stack marketplace platform enabling artists to showcase and sell artwork through secure REST APIs, web and mobile interfaces, and a structured relational data model.",
    "tags": [
      "Java",
      "Spring Boot",
      "Vue.js",
  ...
  {
    "title": "Master Chef — Recipe Sharing Web Application",
    "description": "A Flask-based recipe sharing platform developed through Agile sprints, featuring user-generated content, acceptance testing, and behavior-driven development practices.",
    "tags": [
      "Python",
      "Flask",
      "Pytest",
